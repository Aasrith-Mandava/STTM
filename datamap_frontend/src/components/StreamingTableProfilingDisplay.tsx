...
const StreamingTableProfilingDisplay: React.FC<StreamingTableProfilingDisplayProps> = ({ profilingData, dataDictionary, anomalyData, similarityData, isStep4Skipped = false, exportRef }) => {
